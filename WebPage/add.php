 ...
 <body>
   ...
   <div class="navbar-wrapper">
     ...
     if(!isset($_SESSION['userid'])){
        echo "<script>alert('로그인후 이용해주세요'); history.back();</script>";
		...
		<div id="boardWrite">
			...
			<form action="process_insert.php" method="post" enctype="multipart/form-data">
				...
				<table id="boardWrite">
					...
					<tbody>
						<tr>
							<th scope="row"><label for="uname">닉네임</label></th>

							<td class="id"><input type="text" value="<?=$_SESSION['userid'] ?>" name="name"size="40" required readonly></td>
						...
						<tr>
							...
							<td class="title"><input type="text" name="title"  size="40" required></td>
						...
						<tr>
							...
							<td class="content"><textarea name="content" rows="18" cols="80" required></textarea></td>
