...
public class LoadWallet_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_load_wallet_);
...
//        sb_gas_price.setOnSeekBarChangeListener(seekBarChangeListenerGP);
        ...
        //지갑의 비밀번호를 받아서 가져옴
        //이거조금 변형시킬예정
        String hhh=toooken.getStringExtra("tokennumber");
        passwordwallet=hhh;
...
//    };
    ...
    public void GetGasLimit(String value) {
        ...
        Log.e("gasmania1",tv_gas_limit.getText().toString());
        GetFee();
    }
    public void GetGasPrice(String value) {
        tv_gas_price.setText(value);
        Log.e("gasmania",tv_gas_price.getText().toString());
        GetFee();
    }
    /////////////////////////////////////////////////////////////////
    ...
    public void GetFee(){
        ...
        Log.e("gasmania3", String.valueOf(Convert.toWei(tv_gas_price.getText().toString(),Convert.Unit.GWEI).toBigInteger()));
        Log.e("gasmania4", String.valueOf(GasLimit = BigInteger.valueOf(Integer.valueOf(String.valueOf(tv_gas_limit.getText())))));
        // fee
    ...
    public class WalletCreate extends AsyncTask<Void, Integer, JSONObject> {
        ...
        ProgressDialog progressDialog = new ProgressDialog(LoadWallet_Activity.this);
    ...
    public class SendingToken extends AsyncTask<Void, Integer, JSONObject> {
        ProgressDialog progressDialog2 = new ProgressDialog(LoadWallet_Activity.this);
    ...
    public class SendingEther  extends AsyncTask<Void, Integer, JSONObject> {
        ProgressDialog progressDialog1 = new ProgressDialog(LoadWallet_Activity.this);
