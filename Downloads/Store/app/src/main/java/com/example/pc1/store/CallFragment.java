...
import com.example.pc1.store.CallActivity;
import com.example.pc1.store.CaptureQualityController;
  ...
  public View onCreateView(
    ...
    disconnectButton.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        Intent hello = new Intent(getActivity(),Chatroom_Activity.class);
        startActivity(hello);
