...
import com.example.pc1.store.AppRTCAudioManager;
import com.example.pc1.store.AppRTCClient;
import com.example.pc1.store.R;
...
import com.example.pc1.store.AppRTCAudioManager.AudioDevice;
import com.example.pc1.store.AppRTCAudioManager.AudioManagerEvents;
import com.example.pc1.store.AppRTCClient.RoomConnectionParameters;
import com.example.pc1.store.AppRTCClient.SignalingParameters;
import com.example.pc1.store.PeerConnectionClient.DataChannelParameters;
import com.example.pc1.store.PeerConnectionClient.PeerConnectionParameters;
  ...
  public void onChannelClose() {
    runOnUiThread(new Runnable() {
      ...
      public void run() {
        ...
        disconnect();
        Intent ell=new Intent(getApplicationContext(),Chatroom_Activity.class);
        startActivity(ell);
        finish();
      }
    });
