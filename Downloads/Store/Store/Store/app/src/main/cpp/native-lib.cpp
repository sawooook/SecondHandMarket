//
// Created by saouk on 2018-08-13.
//
#include <jni.h>
//#include <string>
...
//
//JNICALL
//Java_com_example_saouk_Store_Mypage_update_Activity_stringFromJNI(
//        JNIEnv *env,
//        jobject /* this */) {
...
//Java_com_example_pc1_store_test_ConvertRGBtoGray(JNIEnv *env, jobject instance, jlong matAddrInput,
//                                                 jlong matAddrResult) {
//
...
Java_com_example_pc1_store_test_loadCascade(JNIEnv *env, jobject instance,
...
JNIEXPORT void JNICALL
Java_com_example_pc1_store_test_detect(JNIEnv *env, jobject instance, jlong cascadeClassifier_face,
