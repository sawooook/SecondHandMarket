...
<html lang="en">
  ...
  <body>
    ...
    <li><a href="product_cart.php"></a></li>
                                ...
                                <li><a href="three_km.php">관리자로그인</a></li>
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                      <ul class="nav nav-justified">
                        ...
                        <li><a href="SYtoken.php">토큰지급</a></li>
                                        ...
                                        <?php }  else{ ?>
                                          <li><a href="one_km.php">토큰지급</a></li>
  ...
  관리자 로그인 페이지
    <br>
      ...
      <form action="five_km.php" method="POST">
...
<br>
    ...
    <input type="submit" name="signup_button" value="log in" style="height:35px; width:200px;">
